      ...
      {q.data && (
        <>
          ...
          <div className="grid tiles">
            ...
            <Tile n={q.data.facts.regional_owner} k="Regional owner (pending backfill)" />
          ...
          <div className="note small" style={{ marginTop: 20 }}>
            ...
            with a linked re-roof permit. Regional-owner is {q.data.facts.regional_owner} today —
            owner mailing addresses are backfilled in a later stage; the platform reports this
            honestly rather than fabricating localities.
          </div>
        </>
      )}
    </>
